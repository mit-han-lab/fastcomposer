# FastComposer: Tuning-Free Multi-Subject Image Generation with Localized Attention [[website](https://fastcomposer.mit.edu/)] [[demo](http://r1.mit.edu:8080)]
...
We host a demo [here](http://r1.mit.edu:8080). You can also run the demo locally by 
